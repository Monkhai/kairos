...
export default function TickBoxButton({ size = 'base', type = 'primary', varient = 'fill', ...props }: Props) {
  ...
  return (
    ...
    >
      <Canvas style={{ position: 'absolute', width: w, height: h, borderRadius: 8, overflow: 'hidden' }}>
        <RoundedRect height={h} width={w} x={0} y={0} r={8} style={'stroke'} strokeWidth={8} color={primaryColors[type]} />
        <Circle color={primaryColors[type]} cx={0} cy={h} r={markSize} style={'fill'} />
